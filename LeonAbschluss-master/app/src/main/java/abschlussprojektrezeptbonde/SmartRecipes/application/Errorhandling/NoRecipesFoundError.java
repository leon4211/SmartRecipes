...
public class NoRecipesFoundError extends AppCompatActivity {

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.no_recipes_found);
        initToolbar();
    }
    ...
    private void initToolbar() {
        ...
        toolbar.setNavigationOnClickListener(v -> {
            Intent intent = new Intent(NoRecipesFoundError.this, MainActivity.class);
